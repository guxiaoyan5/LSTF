...
from train.train import Trainer, print_model_parameters, AddTrainer
...
args.add_argument('--step', default=8, type=int)
...
# args.add_argument('--T_0', default=5, type=int)
# args.add_argument('--T_mult', default=2, type=int)
args.add_argument('--gamma', default=0.95, type=float)
...
args.add_argument('--nb_filter', default=16, type=int)
...
args.add_argument('--cuda', default=1, type=int)
...
model = LDSTGNN(args.input_dim, args.nb_block, args.input_dim, args.K, args.nb_filter, 1,
                args.y_offsets, args.x_offsets, num_nodes, args.d_model, args.d_k, args.d_v, args.K, args.dropout).to(
    device)
...
if args.step != -1:
    trainer = AddTrainer(model, args.model_name, loss, optimizer, train_loader, val_loader,
                         ...
                         args.decay_r, args.init_r, args.final_r, args.l, args.step)
else:
